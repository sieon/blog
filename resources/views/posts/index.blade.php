                    ...
                    <table class="table table-condensed table-striped">
                        <thead>
                            <tr>
                                ...
                                <th>Title</th> <th>Content</th> <th>User_id</th> <th>Category_id</th> <th>Comment_count</th> <th>View_count</th> <th>Last_comment_user_id</th> <th>Order</th> <th>Excerpt</th> <th>Slug</th>
                        ...
                        <tbody>
                            @foreach($posts as $post)
                                <tr>
                                    ...
                                    <td>{{$post->title}}</td> <td>{{$post->content}}</td> <td>{{$post->user_id}}</td> <td>{{$post->category_id}}</td> <td>{{$post->comment_count}}</td> <td>{{$post->view_count}}</td> <td>{{$post->last_comment_user_id}}</td> <td>{{$post->order}}</td> <td>{{$post->excerpt}}</td> <td>{{$post->slug}}</td>
